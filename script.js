...
function pace () {
    ...
    if (nome !== '' && distancia !== '' && peso !== '' && tempo !== '') {
        ...
        resultado.textContent = `Olá ${nome}! Você percorreu ${distancia}km em ${horas}h${minutos}min${segundos}s, o que implica uma velocidade média de ${pace} com um consumo de ${calorias}!`;
